...
from objectives.violation_number.oracles.OracleHelper import OracleHelper
try:
    ...
    class ModuleDelayOracle:  # type: ignore
        pass

    class ModuleOracle:  # type: ignore
        pass
...
class OracleManager:
    ...
    def set_route_lanelet_ids(self, lanelet_ids):
        self.oh.set_route_lanelet_ids(lanelet_ids)
